...
export function CaseCriminalsForm() {
	...
	return (
		<div className="flex flex-col">
			<div className="font-bold text-2xl">Criminals</div>
			{values.criminals.length !== 0 ? (
				<div className="flex gap-1 flex-col">
					{(values.criminals as NewCriminalPayload[]).map((_, criminalNumber) => (
						<div key={criminalNumber} className="flex flex-col w-full items-end">
				...
				<div className=" text-gray-600">No Criminals added</div>
			)}
