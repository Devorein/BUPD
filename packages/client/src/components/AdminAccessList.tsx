					...
					<div className="flex gap-5 px-5 flex-col overflow-hidden">
						{accesses.map((access, accessIndex) => (
							<div
								...
								className="hover:scale-[1.015] transition-transform duration-300 items-center flex gap-3 border-2 shadow-md p-5 rounded-sm justify-between"
							...
							>
								...
								<div className="flex gap-2">
									<div className="flex items-center gap-2">
										Requesting {PermissionIconRecord[access.permission]} access
									</div>
									<div className="flex items-center gap-2">
										to{' '}
										<span
											...
											className="flex items-center gap-1 uppercase font-bold hover:underline cursor-pointer text-sm"
										>
