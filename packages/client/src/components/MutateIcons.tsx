...
export function MutateIcons(props: MutateIconsProps) {
  const { onViewIconClick, showViewIcon = false, showDeleteIcon = true, showUpdateIcon = true, onDeleteIconClick, onUpdateIconClick } = props;
  ...
  return <div className="flex gap-1 items-center">
    {showViewIcon && <VisibilityIcon sx={svgIconSx} fontSize="small" className="cursor-pointer" style={{
      fill: green[500]
