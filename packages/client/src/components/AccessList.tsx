...
export function AccessList(props: AccessListProps) {
  ...
  return <div className="flex gap-5 flex-col">{
    accesses.map(access => <div className="items-center flex gap-3 border-2 shadow-md px-5 py-2 rounded-sm justify-between" key={access.access_id} style={{ borderColor: '#dad8d85e' }}>
