...
export function Header() {
	...
	const menuItems = [
		<DropDownMenuItem
			iconComponent={<DashboardIcon fontSize="small" />}
			key="dashboard"
			label="Dashboard"
			link={`/`}
		/>,
		<DropDownMenuItem
			iconComponent={<LocalPoliceIcon fontSize="small" />}
			key="polices"
			label="Polices"
			link={`/polices`}
		/>,
		<DropDownMenuItem
			iconComponent={<WorkIcon fontSize="small" />}
			key="casefiles"
			label="Casefiles"
			link={`/casefiles`}
		/>,
		...
		/>,
		<DropDownMenuItem
			iconComponent={<MedicationIcon fontSize="small" />}
			key="victims"
			label="Victims"
			link={`/victims`}
		/>,
		<DropDownMenuItem
			iconComponent={<LockIcon fontSize="small" />}
			key="accesses"
			label="Accesses"
			link={`/accesses`}
		/>,
