...
type FormikTextInputProps = InputHTMLAttributes<HTMLInputElement> & { helperText?: string, name: string, label?: string; placeholder?: string | number, textarea?: boolean, multiline?: boolean, rows?: number, fullWidth?: boolean };
