                ...
                {casefiles.map((casefile) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {casefile.categories && casefile.categories.length !== 0 && <div className="flex flex-col gap-2 mb-3">
                        <div className="text-center font-semibold text-lg">Category</div>
                        <div className="flex gap-3 justify-center">
                          {casefile.categories.map(({ category }) => <span
                      ...
                      {casefile.weapons && casefile.weapons.length !== 0 && <div className="flex flex-col gap-2 mb-3">
                        <div className="text-center font-semibold text-lg">Weapons</div>
                        <div className="flex gap-3 justify-center">
                          {casefile.weapons.map(({ weapon }) => <span
                            className="border-2 px-2 py-1 font-semibold text-sm rounded-md"
                            key="status"
                            style={{
                              backgroundColor: grey[100],
