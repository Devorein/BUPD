...
export default function Casefiles() {
  ...
  return <div className="flex gap-5 justify-center h-full w-full">
    <DeleteModal<ICasefile> isMutationLoading={deleteCasefileMutation.isLoading} onDelete={(selectedData, resetState) => {
      ...
      {({
        ...
        {casefiles.map(casefile => {
          ...
          return <div className="border-2 shadow-md rounded-md p-5 flex flex-col gap-3 relative" key={casefile.case_no}>
            <div>
